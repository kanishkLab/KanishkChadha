...
export default defineConfig({
   ...
   * Link prefetching.
   *
   * Every page on this site is a small static HTML file, so pulling
   * them in as they scroll into view makes navigation resolve
   * instantly instead of showing the transition wait on click.
   * Astro skips prefetching on save-data and 2g connections.
   */
  prefetch: {
    prefetchAll: true,
